...
title <- "**Me**: Hey TidyTuesdayGPT, can you visualize me detectors accuracies <br/>
according to  wether essay was written by a native English writer or not ?"

subtitle <- "**TIdytuesdayGPT**: For sure, here is a pretty quick visualization of detectors accuracies bias according <br/>
writers english fluency, <span style='color:#FFC44E; '>**Native**</span> or <span style='color: #EA0054; '>**Not native**</span>."
...
detectors_acc_df |> 
  ...
  theme(
    ...
    axis.text.y =  element_text(color = "black", size = rel(1.25), family = "DecimaMonoPro"),
    ...
    plot.title = element_markdown(size = rel(1.25), lineheight = unit(1.25, unit = "cm"), hjust = 0.5, margin = margin(t = 0.75,b = 0.75, unit = "cm")), 
    plot.subtitle = element_markdown(size = rel(1.25),lineheight = unit(1.25, unit = "cm"), hjust = 0.5, margin= margin(b = 0.75, unit = "cm")), 
    plot.caption = element_markdown(size = rel(1), hjust = 0.5, margin = margin(t = 0.5, unit = "cm")),
