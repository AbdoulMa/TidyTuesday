...
annotation_1992  <-  "<span style='color : grey30;'>***'This Used To Be My Playground', 'Erotica' and <br>'Deeper And Deeper'***</span> were released.<br>
She can't help falling in love, so <br>
She felt deeper and deeper the further She went."
annotation_1996 <-  "<span style='color : grey30;'>***'Love Don't Live Here Anymore'***</span> <br>enters in Billboard Magazine <br>on 04/20/1996 
at the 91th place."
...
annotation_2012 <- "<span style='color : grey30;'>***'Give Me All Your Luvin'***</span> featuring<br> **Nicki Minaj** & **M.I.A.** in 2012 marks 
...
madonna_years %>% 
  ...
  annotate(geom = "richtext", x = -6.75, y = 99, label = annotation_1992,size = 4,
           vjust = .5, fill = NA, label.size = 0, label.color = NA, family = "Mercury", fontface = "bold") +
  annotate(geom = "richtext", x = -14, y = 116, label = annotation_1996, size = 4,
           vjust = 0, fill = NA, label.size = 0, label.color = NA,family = "Mercury", fontface = "bold") +
  annotate(geom = "text", x = -14, y = 101, label = annotation_1997, vjust = 1,size = 4,
           family = "Mercury", fontface = "bold") +
  annotate(geom = "text", x = -9.95, y = 128, label = annotation_middle, size = 4,
           family = "Mercury", fontface = "bold") +
  annotate(geom = "richtext", x = -4.75, y = 144.5, label = annotation_2012, size = 4,hjust = 1,
           fill = NA, label.size = 0, label.color = NA, family = "Mercury", fontface = "bold") +
  ...
  theme(
    ...
    axis.title = element_text(size = rel(1.25), color = "grey15", family = "Lato Black"),
    ...
    plot.background = element_rect(fill = "#F3F5F6", color = NA)
  )
